...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
    ...
    export OF_TARGET_DEVICES="billie,OnePlusNordN10,OnePlusN10,Billie,oneplusnordn10,billie8"
    export TARGET_DEVICE_ALT="billie,OnePlusNordN10,OnePlusN10,Billie,oneplusnordn10,billie8"
    ...
    export OF_MAINTAINER="Richard M"
    export OF_MAINTAINER_AVATAR="misc/RichardM.png"
    ...
    if [ -n "$OF_MAINTAINER_AVATAR" ]; then
        if [ ! -f "$OF_MAINTAINER_AVATAR" ]; then
              ...
              mkdir -p misc
              curl https://raw.githubusercontent.com/kronflux/device_oneplus_billie-fox/fox_10.0/misc/RichardM.png >> $OF_MAINTAINER_AVATAR
